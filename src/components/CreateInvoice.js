...
const CreateInvoice = ({ setAllData }) => {
    ...
    const handleSelect = (event) => {
        ...
        setForm({ ...form, address: event.target.value.address, name: event.target.value.name, company: event.target.value.company });
        console.log("address", event.target.value.name);
    };
    const handleSelect2 = (event) => {
        setSelect2(event.target.value);
        console.log("form", form);
        setForm({ ...form, toaddress: event.target.value.toaddress, toname: event.target.value.toname, tocompany: event.target.value.tocompany });
        ...
        <>
            ...
            <form className='border-2 border-black w-full p-8 text-base' method="post" encType="multipart/form-data">
                <div className='w-full'>
                    <TextField InputProps={{ sx: { "& input": { textAlign: "center", fontSize: "25px" } } }} variant="standard" onChange={handleChange} value={form.invoice} name="invoice" type="text" className='text-[20px] w-full  overflow-hidden my-0 items-center' />
                </div>
                <div className='flex justify-between w-full'>
                    ...
                    <div className='flex justify-between space-x-2'>
                        <div className='flex flex-col'>
                            <TextField InputProps={{ sx: { fontSize: "12px", color: 'black' } }} variant="standard" onChange={handleChange} value={form.invoiceNo} name="invoiceNo" type="text" />
                            <TextField InputProps={{ sx: { fontSize: "12px", color: 'black' } }} variant="standard" onChange={handleChange} value={form.gst} name="gst" type="text" />
                            <TextField InputProps={{ sx: { fontSize: "12px", color: 'black' } }} variant="standard" onChange={handleChange} value={form.invoiceDate} name="invoiceDate" type="text" />
                            <TextField InputProps={{ sx: { fontSize: "12px", color: 'black' } }} variant="standard" onChange={handleChange} value={form.invoiceDDate} name="invoiceDDate" type="text" />
                        </div>
                        <div className='flex flex-col'>
                            <TextField InputProps={{ sx: { fontSize: "12px", color: 'black' } }} variant="standard" onChange={handleChange} value={form.invoiceNoVal} name="invoiceNoVal" type="text" />
                            <TextField InputProps={{ sx: { fontSize: "12px", color: 'black' } }} placeholder="Gst Number" variant="standard" onChange={handleChange} value={form.gstVal} name="gstVal" type="text" />
                ...
                <div className='flex justify-between items-center pt-8'>
                    <div className='flex flex-col space-y-1'>
                        ...
                        <TextField InputProps={{ sx: { fontSize: "12px", color: 'black', fontWeight: "600" } }} variant="standard" onChange={handleChange} className="my-2 font-semibold" value={form.billFrom} name="billFrom" type="text" />
                    ...
                    <div className='flex flex-col space-y-1'>
                        ...
                        <TextField InputProps={{ sx: { fontSize: "12px", color: 'black' } }} variant="standard" onChange={handleChange} className="my-2 font-semibold" value={form.billTo} name="billTo" type="text" />
                ...
                <div>
                    <div className='bg-gray-800 my-3 rounded-lg py-1 space-x-1 flex justify-between px-3 text-gray-300'>
                        ...
                        <input type="text" onChange={handleChange} value={form.item} name="item" className='!bg-gray-800 focus:bg-gray-700 w-full h-8' />
                        <input type="text" onChange={handleChange} value={form.quantity} name="quantity" className=' !bg-gray-800 focus:bg-gray-700 w-20 !px-0 text-center h-8' />
                        <input type="text" onChange={handleChange} value={form.rate} name="rate" className=' !bg-gray-800 focus:bg-gray-700 w-20 !px-0 text-center h-8' />
                        ...
                        <input type="text" onChange={handleChange} value={form.amount} name="amount" className=' !bg-gray-800 focus:bg-gray-700 w-20 !px-0 text-center h-8 ' />
                    </div>
                    <div>
